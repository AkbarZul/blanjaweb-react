                ...
                <Navbar />
                  <div className="container">
                    ...
                    <Form.Group controlId="formBasicEmail">
                        ...
                        <Form.Control type="text" name="product_description" placeholder="Product Description"  onChange={this.handlerChange}  />
                    </Form.Group>
                    <Form.Group controlId="formBasicEmail">
                    ...
                    <Form.Group controlId="formBasicEmail">
                        <Form.Label>Product jumlah</Form.Label>
                        <Form.Control type="text" name="product_total" placeholder="Product Quantity"  onChange={this.handlerChange} />
                    </Form.Group>
                    <Form.Group controlId="formBasicEmail">
